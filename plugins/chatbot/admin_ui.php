  ...
  <div class="<?php esc_attr_e( 'container form-container',  'wpbot' );  ?> ">
    ...
    <section class="<?php esc_attr_e( 'wp-chatbot-tab-container-inner',  'wpbot' );  ?> ">
      <div class="<?php esc_attr_e( 'wp-chatbot-tabs wp-chatbot-tabs-style-flip',  'wpbot' );  ?> ">
        <nav>
          <ul>
            <li tab-data="started',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=started',  'wpbot' );  ?> "> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-toggle-on',  'wpbot' );  ?> "> </i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
            ...
            <li tab-data="themes',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=themes',  'wpbot' );  ?>"> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-gear faa-spin',  'wpbot' );  ?>"></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
              <?php esc_html_e('ICONS & THEMES', 'wpbot'); ?>
              </span> </a></li>
            <li tab-data="support',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=support',  'wpbot' );  ?>"> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-life-ring',  'wpbot' );  ?> "></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
              <?php esc_html_e('FAQ Builder', 'wpbot'); ?>
              </span> </a></li>
            <li tab-data="language',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=language',  'wpbot' );  ?>"> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-language',  'wpbot' );  ?> "></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
              <?php esc_html_e('LANGUAGE CENTER', 'wpbot'); ?>
              </span> </a></li>
            <li tab-data="startmenu',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=startmenu',  'wpbot' );  ?>"> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-bars',  'wpbot' );  ?> "></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> "><?php esc_html_e('Start Menu', 'wpbot'); ?></span> </a></li>
            
      
            <li tab-data="ai',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=ai',  'wpbot' );  ?> "> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-500px',  'wpbot' );  ?> "></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> ">
              ...
              <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
                <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                  ...
                  <div class="<?php esc_attr_e( 'cxsc-settings-blocks-notic',  'wpbot' );  ?> ">
                    <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><i class="fa fa-check-square-o" aria-hidden="true"></i> <?php esc_html_e('Please see the plugin`s Getting Started section for how to create interactions.', 'wpbot'); ?>
                    <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><i class="fa fa-check-square-o" aria-hidden="true"></i> <?php esc_html_e('The ChatBot can work with ANY language. Just change the texts from the ChatBot Settings->Language Center.', 'wpbot'); ?>
                    <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><i class="fa fa-check-square-o" aria-hidden="true"></i> <?php esc_html_e('Please see the plugin`s Help and Debugging section to troubleshoot common issues.', 'wpbot'); ?>
                  </div>
