...
.container {
    ...
    <h1 class="wp-heading-inline">
     <?php esc_html_e('Simple Text Responses', 'wpbot'); ?></h1>
	 <a href="<?php echo add_query_arg( 'action', 'edit', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php esc_html_e('Add New', 'wpbot'); ?></a>

	<?php if(class_exists('Qcld_str_pro')): ?>
	
	<a href="<?php echo add_query_arg( 'action', 'manage-categories', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php esc_html_e('Manage Categories', 'wpbot'); ?></a>
	<a href="<?php echo admin_url( 'admin-post.php?action=qc_str_export' ); ?>" class="page-title-action"><?php esc_html_e('Export', 'wpbot'); ?></a>
	<a href="<?php echo add_query_arg( 'action', 'import', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php esc_html_e('Import', 'wpbot'); ?></a>
