...
define('QCLD_wpCHATBOT_VERSION', '4.7.0');
            ...
            if (isset($submit)) {
               ...
               if(isset( $_POST["enable_wp_chatbot_mobile_full_screen"])) {
                ...
                if(isset( $_POST["wp_chatbot_show_pages_list"])) {
                    ...
                    update_option('wp_chatbot_show_pages_list', maybe_serialize($wp_chatbot_show_pages_list));
                }else{
                ...
                if(isset( $_POST["wp_chatbot_exclude_post_list"])) {
                    ...
                    update_option('wp_chatbot_exclude_post_list', maybe_serialize($wp_chatbot_exclude_post_list));
                }else{ 
                ...
                update_option('qlcd_wp_chatbot_shopping_cart', maybe_serialize($qlcd_wp_chatbot_shopping_cart));
                $qlcd_wp_chatbot_add_to_cart= @$_POST["qlcd_wp_chatbot_add_to_cart"];
                update_option('qlcd_wp_chatbot_add_to_cart', maybe_serialize($qlcd_wp_chatbot_add_to_cart));
                $qlcd_wp_chatbot_cart_link= @$_POST["qlcd_wp_chatbot_cart_link"];
                update_option('qlcd_wp_chatbot_cart_link', maybe_serialize($qlcd_wp_chatbot_cart_link));
                $qlcd_wp_chatbot_checkout_link= @$_POST["qlcd_wp_chatbot_checkout_link"];
                update_option('qlcd_wp_chatbot_checkout_link', maybe_serialize($qlcd_wp_chatbot_checkout_link));
                $qlcd_wp_chatbot_cart_welcome= @$_POST["qlcd_wp_chatbot_cart_welcome"];
                update_option('qlcd_wp_chatbot_cart_welcome', maybe_serialize($qlcd_wp_chatbot_cart_welcome));
                $qlcd_wp_chatbot_featured_product_welcome= @$_POST["qlcd_wp_chatbot_featured_product_welcome"];
                update_option('qlcd_wp_chatbot_featured_product_welcome', maybe_serialize($qlcd_wp_chatbot_featured_product_welcome));
                $qlcd_wp_chatbot_viewed_product_welcome= @$_POST["qlcd_wp_chatbot_viewed_product_welcome"];
                update_option('qlcd_wp_chatbot_viewed_product_welcome', maybe_serialize($qlcd_wp_chatbot_viewed_product_welcome));
                $qlcd_wp_chatbot_latest_product_welcome= @$_POST["qlcd_wp_chatbot_latest_product_welcome"];
                update_option('qlcd_wp_chatbot_latest_product_welcome', maybe_serialize($qlcd_wp_chatbot_latest_product_welcome));
                $qlcd_wp_chatbot_cart_title= @$_POST["qlcd_wp_chatbot_cart_title"];
                update_option('qlcd_wp_chatbot_cart_title', maybe_serialize($qlcd_wp_chatbot_cart_title));
                $qlcd_wp_chatbot_cart_quantity= @$_POST["qlcd_wp_chatbot_cart_quantity"];
                update_option('qlcd_wp_chatbot_cart_quantity', maybe_serialize($qlcd_wp_chatbot_cart_quantity));
                $qlcd_wp_chatbot_cart_price= @$_POST["qlcd_wp_chatbot_cart_price"];
                update_option('qlcd_wp_chatbot_cart_price', maybe_serialize($qlcd_wp_chatbot_cart_price));
                $qlcd_wp_chatbot_no_cart_items= @$_POST["qlcd_wp_chatbot_no_cart_items"];
                update_option('qlcd_wp_chatbot_no_cart_items', maybe_serialize($qlcd_wp_chatbot_no_cart_items));
                $qlcd_wp_chatbot_cart_updating= @$_POST["qlcd_wp_chatbot_cart_updating"];
                update_option('qlcd_wp_chatbot_cart_updating', maybe_serialize($qlcd_wp_chatbot_cart_updating));
                $qlcd_wp_chatbot_cart_removing= @$_POST["qlcd_wp_chatbot_cart_removing"];
                update_option('qlcd_wp_chatbot_cart_removing', maybe_serialize($qlcd_wp_chatbot_cart_removing));
               ...
               //help welcome and message
                ...
                update_option('qlcd_wp_chatbot_wildcard_product', maybe_serialize($qlcd_wp_chatbot_wildcard_product));
                $qlcd_wp_chatbot_wildcard_catalog = @$_POST["qlcd_wp_chatbot_wildcard_catalog"];
                update_option('qlcd_wp_chatbot_wildcard_catalog', maybe_serialize($qlcd_wp_chatbot_wildcard_catalog));
                $qlcd_wp_chatbot_featured_products = @$_POST["qlcd_wp_chatbot_featured_products"];
                update_option('qlcd_wp_chatbot_featured_products', maybe_serialize($qlcd_wp_chatbot_featured_products));
                $qlcd_wp_chatbot_sale_products = @$_POST["qlcd_wp_chatbot_sale_products"];
                update_option('qlcd_wp_chatbot_sale_products', maybe_serialize($qlcd_wp_chatbot_sale_products));
                ...
                update_option('qlcd_wp_chatbot_messenger_label', maybe_serialize($qlcd_wp_chatbot_messenger_label));
                //Products search .
                ...
                if (isset($_POST["qlcd_wp_chatbot_product_fail"])) {
                    ...
                    update_option('qlcd_wp_chatbot_product_fail', maybe_serialize($qlcd_wp_chatbot_product_fail));
                }
                $qlcd_wp_chatbot_product_asking = @$_POST["qlcd_wp_chatbot_product_asking"];
                update_option('qlcd_wp_chatbot_product_asking', maybe_serialize($qlcd_wp_chatbot_product_asking));
                $qlcd_wp_chatbot_product_suggest = @$_POST["qlcd_wp_chatbot_product_suggest"];
                update_option('qlcd_wp_chatbot_product_suggest', maybe_serialize($qlcd_wp_chatbot_product_suggest));
                $qlcd_wp_chatbot_product_infinite = @$_POST["qlcd_wp_chatbot_product_infinite"];
                update_option('qlcd_wp_chatbot_product_infinite', maybe_serialize($qlcd_wp_chatbot_product_infinite));
                $qlcd_wp_chatbot_load_more = @$_POST["qlcd_wp_chatbot_load_more"];
                update_option('qlcd_wp_chatbot_load_more', maybe_serialize($qlcd_wp_chatbot_load_more));
                //Order
                $qlcd_wp_chatbot_wildcard_order = @$_POST["qlcd_wp_chatbot_wildcard_order"];
                update_option('qlcd_wp_chatbot_wildcard_order', maybe_serialize($qlcd_wp_chatbot_wildcard_order));
                $qlcd_wp_chatbot_order_welcome = @$_POST["qlcd_wp_chatbot_order_welcome"];
                update_option('qlcd_wp_chatbot_order_welcome', maybe_serialize($qlcd_wp_chatbot_order_welcome));
                $qlcd_wp_chatbot_order_username_asking = @$_POST["qlcd_wp_chatbot_order_username_asking"];
                update_option('qlcd_wp_chatbot_order_username_asking', maybe_serialize($qlcd_wp_chatbot_order_username_asking));
                $qlcd_wp_chatbot_order_username_not_exist = @$_POST["qlcd_wp_chatbot_order_username_not_exist"];
                update_option('qlcd_wp_chatbot_order_username_not_exist', maybe_serialize($qlcd_wp_chatbot_order_username_not_exist));
                ...
                update_option('qlcd_wp_chatbot_order_username_password', maybe_serialize($qlcd_wp_chatbot_order_username_password));
                $qlcd_wp_chatbot_order_password_incorrect= @$_POST["qlcd_wp_chatbot_order_password_incorrect"];
                update_option('qlcd_wp_chatbot_order_password_incorrect', maybe_serialize($qlcd_wp_chatbot_order_password_incorrect));
                $qlcd_wp_chatbot_order_not_found= @$_POST["qlcd_wp_chatbot_order_not_found"];
                update_option('qlcd_wp_chatbot_order_not_found', maybe_serialize($qlcd_wp_chatbot_order_not_found));
                $qlcd_wp_chatbot_order_found= @$_POST["qlcd_wp_chatbot_order_found"];
                update_option('qlcd_wp_chatbot_order_found', maybe_serialize($qlcd_wp_chatbot_order_found));
                $qlcd_wp_chatbot_order_email_support= @$_POST["qlcd_wp_chatbot_order_email_support"];
                update_option('qlcd_wp_chatbot_order_email_support', maybe_serialize($qlcd_wp_chatbot_order_email_support));
                //Support
                ...
                update_option('qlcd_wp_chatbot_no_result', maybe_serialize($qlcd_wp_chatbot_no_result));
				
                $qlcd_wp_chatbot_support_option_again = @$_POST["qlcd_wp_chatbot_support_option_again"];
                update_option('qlcd_wp_chatbot_support_option_again', maybe_serialize($qlcd_wp_chatbot_support_option_again));
                $qlcd_wp_chatbot_invalid_email = @$_POST["qlcd_wp_chatbot_invalid_email"];
                update_option('qlcd_wp_chatbot_invalid_email', maybe_serialize($qlcd_wp_chatbot_invalid_email));
                ...
                update_option('qlcd_wp_chatbot_asking_phone', maybe_serialize($qlcd_wp_chatbot_asking_phone));
                $qlcd_wp_chatbot_thank_for_phone= @$_POST["qlcd_wp_chatbot_thank_for_phone"];
                update_option('qlcd_wp_chatbot_thank_for_phone', maybe_serialize($qlcd_wp_chatbot_thank_for_phone));
                $qlcd_wp_chatbot_admin_email = sanitize_email(@$_POST["qlcd_wp_chatbot_admin_email"]);
                ...
                update_option('qlcd_wp_chatbot_notifications', maybe_serialize($qlcd_wp_chatbot_notifications));
                ...
                update_option('qlcd_wp_chatbot_whats_label', maybe_serialize($qlcd_wp_chatbot_whats_label));
               ...
               //Viber
                ...
                update_option('qlcd_wp_chatbot_feedback_label', maybe_serialize($qlcd_wp_chatbot_feedback_label));
                ...
                update_option('wpwbot_hours', maybe_serialize($wpwbot_hours));
                ...
                update_option('wp_chatbot_header_background_color', sanitize_text_field($wp_chatbot_header_background_color));
...
function qcld_wb_chatboot_defualt_options(){
  ...
  if(!get_option('qlcd_wp_chatbot_messenger_label')) {
    ...
    if(!get_option('qlcd_wp_chatbot_product_fail')) {
        update_option('qlcd_wp_chatbot_product_fail', maybe_serialize(array('Oops! Nothing matches your criteria', 'Sorry, I found nothing')));
    }
...
<div class="wrap swpm-admin-menu-wrap">
    <div class="<?php esc_attr_e( 'cxsc-settings-blocks-notic',  'wpbot' );  ?>" style="<?php echo esc_attr('background: #2271B1;color:#fff'); ?>">
