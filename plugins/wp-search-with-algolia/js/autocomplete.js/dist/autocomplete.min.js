...
/***/ function(module, exports, __webpack_require__) {
	...
	function Typeahead(o) {
	  ...
	  this.dropdown = new Typeahead.Dropdown({
	    ...
	    wrapper: this.$node,
	    menu: $menu,
	    datasets: o.datasets.slice(0,20),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Dropdown(o) {
	  ...
	  this.$menu = DOM.element(o.menu)
	    ...
	    var self = this;
	    this.$menu.parent().scroll(function(e){
	   		console.log('scrolltop',this.scrollTop)
	   		console.log('scrollheight',this.scrollHeight - this.offsetHeight);
		  	if(this.scrollTop >= (this.scrollHeight - this.offsetHeight))
		  	{
		  		...
		  		self.timer = window.setTimeout(()=>{
		  			_.map(self.datasets,function(dataset){
			  			dataset.updatelength()	
			  		})
		  		},1000)
	  ...
	  _render: function render(query, suggestions) {
	    ...
	    function getSuggestionsHtml() {
	     ...
	     var suggestionsHtml = html.suggestions.
	      ...
	      nodes = _.map(suggestions.slice(0,this.length), getSuggestionNode);
	  ...
	  update: function update(query) {
	    ...
	    function handleSuggestions(suggestions) {
	      ...
	      if (!this.canceled && query === this.query) {
	        ...
	        {
	        	if(!suggestions[item].parent)
	        	{
	        		titlearray.push(suggestions[item].post_title);
	        	}
	        ...
	        if(titlearray.length > 0)
	        {
	        	$.ajax({
		        	...
		        	type:'POST',
		        	data:{title:titlearray,action:'getparent'},
		        	success:function(res){
		        		res = JSON.parse(res)
		        		for(let item in suggestions)
		        		{
		        			if(res[suggestions[item].post_title])
		        			{
		        				suggestions[item].parent = res[suggestions[item].post_title]
		        			}
		        		}


		        		that.cacheSuggestions(query, suggestions, extraArgs);
		        		that._render.apply(that, [query, suggestions].concat(extraArgs));
		        	}
		        })
	        }
	        else
	        {
	        	that.cacheSuggestions(query, suggestions, extraArgs);
		        that._render.apply(this, [query, suggestions].concat(extraArgs));
	        }
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function search(index, params) {
	  ...
	  function sourceFn(query, cb) {
 		params['attributesToSnippet'] = ['content:100'];
