                ...
                <?php if ($below_part['full_side'])  { ?>
                    ...
                    <div class="wp-block-columns alignfull"><!-- wp:column -->
                        <div class="wp-block-column"><!-- wp:content-design/do -->
                            <img src="<?php echo $below_part['full_side']['left_image']; ?>" style="display:block;margin-bottom:16px; margin-top: 16px;"  alt="<?php echo $below_part['full_side']['left_image']['alt']; ?>"/>
                            <?php echo $below_part['full_side']['description_left']; ?>
                        </div>
                        <div class="wp-block-column"><!-- wp:content-design/do -->
                            <img src="<?php echo $below_part['full_side']['right_image']; ?>" style="display:block;margin-bottom:16px; margin-top: 16px;" alt="<?php echo $below_part['full_side']['right_image']['alt']; ?>"/>
                ...
                <div class="row image-text-part-two">
                    <div class="col-sm-6">       
                        <div class="com-image-text-one com-image-text-left">
                            <div class="img_wrap">
                                <img src="<?php echo $below_part['community_2_col_images']['left_image']['url'];?>"  alt="<?php echo $below_part['community_2_col_images']['left_image']['alt']; ?>">
                            </div>
                    ...
                    <div class="col-sm-6 sec-one">      
                        <div class="com-image-text-two com-image-text-right" >
                            <div class="img_wrap">
                                <img src="<?php echo $right_image = $below_part['community_2_col_images']['right_image']['url'];?>" alt="<?php echo $below_part['community_2_col_images']['right_image']['alt']; ?>">
                            </div>
                        ...
                        <div class="row articles_three_col">
                            <div class="col-sm-4 fir-part">     
                                <a class="com-each-section" href="<?php echo $left_text = $below_part['community_3_col_images']['article_i']['link']['url']; ?>">
                                    <div class="com-each-section" >
                                        <div class="img_wrap">
                                            <img src="<?php echo $left_image = $below_part['community_3_col_images']['article_i']['image']['url'];?>" alt="<?php echo $below_part['community_3_col_images']['article_i']['image']['alt'];?>">
                                        </div>
                                        <div class="text_wrap">
                                            <div class="">
                            ...
                            <div class="col-sm-4 sec-part">     
                                <a class="com-each-section" href="<?php echo $left_text = $below_part['community_3_col_images']['article_ii']['link']['url']; ?>">
                                    <div class="com-each-section" >
                                        <div class="img_wrap">
                                            <img src="<?php echo $below_part['community_3_col_images']['article_ii']['image']['url'];?>" alt="<?php echo $below_part['community_3_col_images']['article_ii']['image']['alt'];?>">
                                        </div>
                                        <div class="text_wrap">
                                            <div class="">
                                ...
                                <div class="home-each-section" style="display: none;">
                                    <div class="img_wrap">
                                        <img src="<?php echo $below_part['community_3_col_images']['article_ii']['image']['url'];?>" alt="<?php echo $center_image = $below_part['community_3_col_images']['article_ii']['image']['alt'];?>">
                                    </div>
                                    <div class="text_wrap">
                                        <div class="title">
                                            <?php echo $center_title = $below_part['community_3_col_images']['article_ii']['title']; ?>                 
                            ...
                            <div class="col-sm-4 third-part">       
                                <a class="com-each-section" href="<?php echo $left_text = $below_part['community_3_col_images']['article_iii']['link']['url']; ?>" >
                                    <div class="com-each-section" >
                                        <div class="img_wrap">
                                            <img src="<?php echo $right_image = $below_part['community_3_col_images']['article_iii']['image']['url'];?>" alt="<?php echo  $below_part['community_3_col_images']['article_iii']['image']['alt'];?>">
                                        </div>
                                        <div class="text_wrap">
                                            <div class="">
                                ...
                                <div class="home-each-section" style="display: none;">  
                                    <div class="img_wrap">
                                        <img src="<?php echo $right_image = $below_part['community_3_col_images']['article_iii']['image']['url'];?>" alt="<?php echo $right_image = $below_part['community_3_col_images']['article_iii']['image']['alt'];?>">
                                    </div>
                                    <div class="text_wrap">
                                        <div class="title">
                                            <?php echo $right_title = $below_part['community_3_col_images']['article_iii']['title']; ?>         
                        ...
                        <div class="row image-text-part-one" style="margin: auto;">
                            <div class="col-12">        
                                <div class="com-image-text" >
                                    ...
                                    <div class="img_wrap">
                                        <img src="<?php echo $com_image = $below_part['community_1_col_image']['com_image']['url'];?>" loading=”lazy” alt="<?php echo $com_image = $below_part['community_1_col_image']['com_image']['alt'];?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style type="text/css">
    ...
    .page-template-template-community #main {
        margin-left: 0;
    }
...
<style type="text/css">
    ...
    .page-template-template-community .my-header a {
        margin-left: 45px;
    }
...
<style type="text/css">
    ...
    @media (max-width: 560px) {
        ...
        .page-template-template-community .each-image-slider .content-area .desc-area {
            margin-top: 0 !important;
        }
        .page-template-template-community .each-image-slider .content-area .title-area h2{
            font-size: 32px !important;
            line-height: 40px !important;
        }
        .page-template-template-community .each-image-slider p {
    ...
    .page-template-template-community .content-design-page #content-design-menu {
        z-index: 100;
...
<script type="text/javascript">
  ...
  $('.wp-block-navigation-item__content').click(function(e) {
      ...
      if ( typeof fullpageNum != "undefined" && typeof fullpage_api != "undefined" ) {
